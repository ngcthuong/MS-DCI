...
networkTest = { 'DoC-DCS1' 'DoC-DCS2' 'DoC-DCS3'};
...
%         %% =========== Decomposition ===================================
%         im1     = squeeze(gather(net.vars(3).value));  
%         
%         %imagesc(im1); axis square;axis off; colormap(gray); colorbar;set(gca, 'fontsize', 18);         
%         %im      = export_fig; imwrite(im, ['Decomp\1' modelName '_rate' num2str(subRate) '_grey.tif']);
%         
%         im2     = squeeze(gather(net.vars(5).value));  %imagesc(im2);
%         %axis square;axis off; colormap(gray); colorba%r;set(gca, 'fontsize', 18); 
%         %im      = export_fig; imwrite(im, ['Decomp\2' modelName '_rate' num2str(subRate) '_grey.tif']);
%         
%         im3     = squeeze(gather(net.vars(7).value));  %imagesc(im3); 
%         %axis square;axis off; colormap(gray); colorbar;set(gca, 'fontsize', 18);         
%         %im      = export_fig; imwrite(im, ['Decomp\3' modelName '_rate' num2str(subRate) '_grey.tif']);
%         
%         im4     = squeeze(gather(net.vars(8).value));  %imagesc(im4); 
%         
