...
networkTest = {'W-DCS1' 'W-DCS2' 'W-DCS3'};  % 102 
...
%         k0 = 5; 
        ...
        for idx1 = 1:1:2
            ...
            for idx2 = 1:1:2
                ...
                imwrite(im, ['mtxResults_color\' tLegend{idx} '_meas_' modelName ...
                    '_rate' num2str(subRate) '_'  num2str(color_range(idx1, idx2)) '.png']);
        
            end
            
            %tmpBig = padarray(tmpBig, [padSize(subRate_id) + 20, 0], 255, 'post'); 
...
%         
%         
%         pr = figure(7);     imagesc(Phi_i, [-rangeSize(subRate_id), rangeSize(subRate_id)]); axis square;axis off; 
%         colormap(parula);   colorbar; 
%         saveas(pr, ['mtxResults_color\colorbar_' num2str(rangeSize(subRate_id)) '.tif']);
